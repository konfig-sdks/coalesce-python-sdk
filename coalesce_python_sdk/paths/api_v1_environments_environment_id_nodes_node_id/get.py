...
from coalesce_python_sdk.model.node import Node as NodeSchema
...
from coalesce_python_sdk.pydantic.node import Node as NodePydantic

from . import path

# Path params
EnvironmentIDSchema = schemas.StrSchema
NodeIDSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'environmentID': typing.Union[EnvironmentIDSchema, str, ],
        'nodeID': typing.Union[NodeIDSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = NodeSchema
    ...
    async def _aget_information_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/environments/{environmentID}/nodes/{nodeID}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetInformation(BaseApi):
    ...
    async def aget_information(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[NodePydantic](raw_response.body).root
        return api_client.construct_model_instance(NodePydantic, raw_response.body)
