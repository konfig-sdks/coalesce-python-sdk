...
from coalesce_python_sdk.model.run_results_response import RunResultsResponse as RunResultsResponseSchema

from coalesce_python_sdk.type.run_results_response import RunResultsResponse
...
from coalesce_python_sdk.pydantic.run_results_response import RunResultsResponse as RunResultsResponsePydantic

# Path params
RunIDSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'runID': typing.Union[RunIDSchema, decimal.Decimal, int, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = RunResultsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RunResultsResponse
    ...
    async def _alist_results_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/runs/{runID}/results',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListResultsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_results(
        self,
        run_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_results_mapped_args(
            run_id=run_id,
        )
        return await self._alist_results_oapg(
    ...
    def list_results(
        ...
        return self._list_results_oapg(
            path_params=args.path,
        )

class ListResults(BaseApi):
    ...
    async def alist_results(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RunResultsResponsePydantic:
        raw_response = await self.raw.alist_results(
            run_id=run_id,
            **kwargs,
        )
        if validate:
            return RunResultsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RunResultsResponsePydantic, raw_response.body)
    ...
    def list_results(
        ...
        raw_response = self.raw.list_results(
            run_id=run_id,
        )
        if validate:
            return RunResultsResponsePydantic(**raw_response.body)
