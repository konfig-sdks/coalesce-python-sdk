...
from coalesce_python_sdk.model.base_environment import BaseEnvironment as BaseEnvironmentSchema
...
from coalesce_python_sdk.pydantic.base_environment import BaseEnvironment as BaseEnvironmentPydantic
...
SchemaFor200ResponseBodyApplicationJson = BaseEnvironmentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BaseEnvironment
    ...
    async def _aget_information_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/environments/{environmentID}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetInformation(BaseApi):
    ...
    async def aget_information(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BaseEnvironmentPydantic:
        raw_response = await self.raw.aget_information(
            environment_id=environment_id,
            **kwargs,
        )
        if validate:
            return BaseEnvironmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(BaseEnvironmentPydantic, raw_response.body)
