...
from coalesce_python_sdk.model.run_info import RunInfo as RunInfoSchema
...
from coalesce_python_sdk.pydantic.run_info import RunInfo as RunInfoPydantic
...
SchemaFor200ResponseBodyApplicationJson = RunInfoSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_run_details_mapped_args(
        self,
        run_id: int,
    ...
    async def _aget_run_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/runs/{runID}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRunDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_run_details(
        self,
        run_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_run_details_mapped_args(
            run_id=run_id,
        )
        return await self._aget_run_details_oapg(
    ...
    def get_run_details(
        ...
        return self._get_run_details_oapg(
            path_params=args.path,
        )

class GetRunDetails(BaseApi):
    ...
    async def aget_run_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_run_details(
            run_id=run_id,
            **kwargs,
        )
        if validate:
            return RunInfoPydantic(**raw_response.body)
        return api_client.construct_model_instance(RunInfoPydantic, raw_response.body)
    ...
    def get_run_details(
        ...
        raw_response = self.raw.get_run_details(
            run_id=run_id,
        )
        if validate:
            return RunInfoPydantic(**raw_response.body)
