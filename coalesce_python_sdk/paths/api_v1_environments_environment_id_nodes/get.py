...
from coalesce_python_sdk.model.nodes_response import NodesResponse as NodesResponseSchema

from coalesce_python_sdk.type.nodes_response import NodesResponse
from coalesce_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from coalesce_python_sdk.pydantic.nodes_response import NodesResponse as NodesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NodesResponseSchema
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/environments/{environmentID}/nodes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return NodesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(NodesResponsePydantic, raw_response.body)
