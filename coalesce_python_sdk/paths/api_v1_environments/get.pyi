...
from coalesce_python_sdk.model.environments_response import EnvironmentsResponse as EnvironmentsResponseSchema

from coalesce_python_sdk.type.environments_response import EnvironmentsResponse
from coalesce_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from coalesce_python_sdk.pydantic.environments_response import EnvironmentsResponse as EnvironmentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EnvironmentsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EnvironmentsResponse
    ...
    async def _alist_information_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/environments',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListInformation(BaseApi):
    ...
    async def alist_information(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EnvironmentsResponsePydantic:
        raw_response = await self.raw.alist_information(
            detail=detail,
            **kwargs,
        )
        if validate:
            return EnvironmentsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EnvironmentsResponsePydantic, raw_response.body)
