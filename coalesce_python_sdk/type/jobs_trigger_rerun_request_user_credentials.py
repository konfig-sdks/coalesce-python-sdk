...
class RequiredJobsTriggerRerunRequestUserCredentials(TypedDict):
    pass

class OptionalJobsTriggerRerunRequestUserCredentials(TypedDict, total=False):
...
class JobsTriggerRerunRequestUserCredentials(RequiredJobsTriggerRerunRequestUserCredentials, OptionalJobsTriggerRerunRequestUserCredentials):
    pass
